...
@interface JJActivityOrderCodeCell ()
...
@implementation JJActivityOrderCodeCell
...
//    self.backgroundColor = RGBA(247, 247, 247, 1);
    ...
    codeIcon.userInteractionEnabled = YES;
    [JJAvatarBrowser showImage:codeIcon];
    [codeIcon createBordersWithColor:RGBA(153, 153, 153, 1) withCornerRadius:0 andWidth:1];
   ...
   //消费凭证
    ...
    [instructLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.codeLabel.mas_bottom).with.offset(10 * KWIDTH_IPHONE6_SCALE);
        make.left.equalTo(self.codeIcon.mas_right).with.offset(10 * KWIDTH_IPHONE6_SCALE);
